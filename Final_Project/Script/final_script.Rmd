...
::: {style="text-align: center; font-size: 25px; margin-top: 20px; margin-bottom: 20px"}
...
```
::: {style="text-align: center; font-size: 25px; margin-top: 20px; margin-bottom: 20px"}
9 populations capture a 450 mm - 1325 mm MAR precipitation gradient
:::
...
```
::: {style="text-align: center; font-size: 25px; margin-top: 20px; margin-bottom: 20px"}
Comparing global mean chlorophyll content of drought and control groups  
:::
...
::: {style="text-align: center; font-size: 25px; margin-top: 20px; margin-bottom: 20px"}
Mechanistic insight on population variability in chlorophyll content over time
:::
